   // Supabase Configuration
    ...
    const texts = {
        pashto: {
            ...
            confirmReset: "آیا مطمئن هستید که میخواهید تمام دادهها را پاک کنید؟",
        ...
        dari: {
            ...
            toastUpdated: "اطلاعات تلفون بهروز شد!",
            toastDeleted: "تلفون از لیست حذف شد!",
            toastError: "لطفاً تمام اطلاعات ضروری را پر کنید!",
            toastLoginSuccess: "ورود به سیستم موفقیتآمیز بود!",
            toastRegisterSuccess: "ثبتنام با موفقیت انجام شد!",
            toastResetDb: "دیتابیس با موفقیت بازنشانی شد!",
            languageText: "دری",
            connected: "متصل به دیتابیس",
            disconnected: "عدم اتصال به دیتابیس",
            syncSuccess: "همگامسازی با دیتابیس انجام شد!",
            confirmDelete: "آیا مطمئن هستید؟",
            confirmReset: "آیا مطمئن هستید که میخواهید تمام دادهها را پاک کنید؟",
            accessDenied: "شما دسترسی لازم برای این عملیات را ندارید"
        }
    ...
    async function handleRegister(e) {
        ...
        try {
            ...
            showToast('خطا', 'خطا در ثبتنام. لطفاً دوباره تلاش کنید', 'error');
        } finally {
